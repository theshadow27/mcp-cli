...
registerHelp("claude auth", {
  ...
  notes: [
    ...
    "`load`. 429s back off (Retry-After / exponential, capped at 60s); a throttled",
    "profile is recorded and the walk continues with retries off, and the whole sweep",
    "is bounded by a 2-minute wall-clock budget. Both flags copy a token Claude",
