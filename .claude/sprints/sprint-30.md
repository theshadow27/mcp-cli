...
> Planned 2026-04-11 07:30. Target: 12 PRs.
...
#1181 is the CI blocker — bun test exits 1 on Linux despite 0 failures. Everything else is independent cleanup: clone tests, frontmatter fix, lint rule, install.sh fix.
...
Asana spike — we have an Asana server configured (SSE, 44 tools). Explore the API surface and implement a provider. Docs update is a sonnet filler.
