...
> Planned 2026-03-29 21:00. Target: 15 PRs.
...
| **1049** | **mcx claude wait/ls --gh (PR/CI status)** | **medium** | **2** | **opus** | **goal** |
...
#1010 (dep: #1009), #1049, #1011 (dep: #1010), #1012 (dep: #1010), #1028, #1024

#1010 (scope detection) unblocks #1011 and #1012 which can run in parallel. #1049 (--gh flag) is independent. #1028 (cost tracking) and #1024 (flaky daemon integration) fill the remaining slots.
